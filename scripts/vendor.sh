...
echo "==> fonts: Source Serif 4 (latin, variable weight) upright + italic"
cp "$(find1 '*/source-serif-4-latin-wght-normal.woff2')" "$FONTS/SourceSerif4-VF.woff2"
cp "$(find1 '*/source-serif-4-latin-wght-italic.woff2')" "$FONTS/SourceSerif4-Italic-VF.woff2"

echo "==> fonts: Source Sans 3 (latin) 400 / 600 / 700 + 400 italic (alternate reading face)"
